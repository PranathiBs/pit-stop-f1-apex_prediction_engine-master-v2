    ...
    return (
        <div className={styles.tracker}>
            <div className={styles.tabs}>
                ...
                >
                    <SpeedometerIcon size={14} color={activeTab === 'speed' ? '#E10600' : 'currentColor'} />
                ...
                >
                    <PitStopIcon size={14} color={activeTab === 'pits' ? '#E10600' : 'currentColor'} />
                    <span>Pit Stops</span>
                </button>
            </div>
                                ...
                                <div className={styles.barArea}>
                                    <div className={styles.barBg}>
                                        <div
                                            ...
                                            style={{
                                                width: `${pct}%`,
                                                background: i === 0 ? 'linear-gradient(90deg, #E10600, #ff4136)' :
                                                    i < 3 ? 'linear-gradient(90deg, #E10600, rgba(225,6,0,0.5))' :
