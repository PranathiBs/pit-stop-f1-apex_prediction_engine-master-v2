            ...
            <div className={styles.container}>
                <div className={styles.header}>
                    <div className={styles.headerLeft}>
                        <div className={styles.titleIcon}><TrophyIcon size={28} color="#a0d9f8" /></div>
                        <div>
                ...
                <div className={styles.tabs}>
                    ...
                    >
                        <HelmetIcon size={16} color={activeTab === 'drivers' ? '#a0d9f8' : 'currentColor'} />
                        <span>Drivers</span>
                    </button>
                    <button
                    ...
                    >
                        <ConstructorIcon size={16} color={activeTab === 'constructors' ? '#a0d9f8' : 'currentColor'} />
