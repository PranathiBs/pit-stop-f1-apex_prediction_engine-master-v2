    ...
    const fetchRaces = useCallback(async () => {
        ...
        const weatherPromises = upcoming.map(async (race: Race) => {
            const weather = await getCurrentWeather(
                ...
                { year: parseInt(race.season), gp: race.raceName, session: 'Race' }
            );
        ...
        results.forEach((r: { circuitId: string, weather: WeatherData | null }) => {
                        ...
                        <div className={styles.statusBanner}>
                            ...
                            {filter === 'upcoming' && (
                                <div className={`${styles.bannerContent} ${styles.upcomingTag}`}>
                                    <ClockIcon size={20} color="#a0d9f8" />
                                    <div className={styles.bannerText}>
                            ...
                            {filteredRaces.map((race, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className={styles.cardStripe} style={{ background: circuit?.color || '#a0d9f8' }} />
                                    </Link>
                                );
                            })}
                        </div>
