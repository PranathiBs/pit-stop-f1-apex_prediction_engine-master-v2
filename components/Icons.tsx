...
// ===== SIMPLIFIED PIT STOP LOGO — CLEAN PS MARK =====
export function CheckeredFlag({ size = 32, className }: IconProps) {
    return (
        ...
        >
            ...
            <circle cx="30" cy="30" r="22" stroke="rgba(255,30,30,0.15)" strokeWidth="1" fill="none">
                <animate attributeName="r" values="20;24;20" dur="3s" repeatCount="indefinite" />
                <animate attributeName="opacity" values="0.1;0.3;0.1" dur="3s" repeatCount="indefinite" />
            </circle>

            {/* Main PS Center Text Logo */}
            <g filter="url(#logoGlow)">
                ...
                >
                    <tspan fill="#ff1e1e">P</tspan>S
                </text>
                {/* Sharp Underline */}
                <path d="M18 41 L42 41" stroke="#ff1e1e" strokeWidth="2.5" strokeLinecap="square" />
            </g>
        </svg>
    );
}
...
export function RacingCarIcon({ size = 20, color = 'currentColor', className }: IconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
            {/* Floor / Ground */}
            <line x1="2" y1="17" x2="23" y2="17" />
            
            {/* Body silhouette */}
            <path d="M 23 17 V 15.5 H 21 Q 19 15 17 14 L 14 13 Q 13 9 11 9 H 9 L 5 13 H 3" fill={color} fillOpacity="0.15" />
            <path d="M 23 17 V 15.5 H 21 Q 19 15 17 14 L 14 13 Q 13 9 11 9 H 9 L 5 13 H 3" />
            
            {/* Driver helmet */}
            <circle cx="13.5" cy="11.5" r="1.2" fill={color} stroke="none" />
            
            {/* Halo / Cockpit rim */}
            <path d="M 14.5 13 Q 14.5 11 12 11" strokeWidth="1" />
            
            {/* Rear wing element */}
            <path d="M 3 14 V 7 H 6 V 9 H 4 V 14" fill={color} fillOpacity="0.15" />
            <path d="M 3 14 V 7 H 6 V 9 H 4 V 14" />
            <line x1="3" y1="8.5" x2="5" y2="8.5" />
            
            {/* Front Wheel */}
            <circle cx="18" cy="15.5" r="3.5" fill={color} fillOpacity="0.1" stroke={color} strokeWidth="1.5" />
            <circle cx="18" cy="15.5" r="1.2" fill={color} stroke="none" />
            <circle cx="18" cy="15.5" r="2.5" stroke={color} strokeWidth="0.5" strokeDasharray="1 1" />
            
            {/* Rear Wheel */}
            <circle cx="7" cy="15.5" r="3.5" fill={color} fillOpacity="0.1" stroke={color} strokeWidth="1.5" />
            <circle cx="7" cy="15.5" r="1.2" fill={color} stroke="none" />
            <circle cx="7" cy="15.5" r="2.5" stroke={color} strokeWidth="0.5" strokeDasharray="1 1" />

            {/* Speed lines */}
            <line x1="0" y1="11" x2="2" y2="11" opacity="0.4" />
            <line x1="1" y1="14" x2="2" y2="14" opacity="0.4" />
            <line x1="0" y1="18" x2="3" y2="18" opacity="0.4" />
        </svg>
    );
}
