...
export default function CircuitPage() {
    ...
    return (
        <div className={styles.page}>
            {/* Hero Header */}
            <section className={styles.hero} style={{ '--accent': circuitDetail?.color || '#E10600' } as React.CSSProperties}>
            ...
            <div className={styles.container}>
                ...
                <section className={styles.statsGrid}>
                    <div className={styles.statCard}>
                        <span className={styles.statIcon}><CircuitIcon size={20} color="#E10600" /></span>
                    ...
                    {trackData && (
                        <>
                            <div className={styles.statCard}>
                                <span className={styles.statIcon}><FlagIcon size={20} color="#E10600" /></span>
                                ...
                                <div key={day.date} className={styles.forecastCard}>
                                    ...
                                    {day.weather.rain_probability > 20 && (
                                        <div className={styles.forecastRain}>
                                            🌧️ {Math.round(day.weather.rain_probability)}%
                                        </div>
                                    )}
                                </div>
                            ))}
                ...
                {strategies.length > 0 && (
                    <section className={styles.strategySection}>
                        <h2 className={styles.sectionTitle}><TyreIcon size={22} color="#E10600" /> Predicted Tyre Strategy</h2>
                ...
                {pastResults.length > 0 && pastResults[0].Results && (
                    <section className={styles.resultsSection}>
                        <h2 className={styles.sectionTitle}><FlagIcon size={22} color="#E10600" /> {new Date().getFullYear()} Race Results</h2>
